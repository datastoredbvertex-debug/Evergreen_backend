const FestivelTemplate = (response) => {
                       ...
                       response.image
                        ...
                        <table
                              ...
                              <a href="${response.image}">
                                    <img src="${response.image}" alt="Landscape-Design" border="0" style="display: block; margin: 20px auto;" />
                              </a>
                              </td>
                                </tr>
                           </table>`
...
module.exports = { FestivelTemplate };
