const TerminationTemplate = (userdata) => {
  return `
                                      ...
                                      <tr>
                                        ...
                                        >
                                          ...
                                          <p
                                            ...
                                            "
                                          >
                                            <strong style="font-weight: 900">Mobile</strong> +91-1234567890
                                          </p>
                                          <p
                                            style="
                                              margin: 0;
                                            ...
                                            "
                                          >
                                            <strong style="font-weight: 900">E-Mail</strong> Ever@gmail.ocm
                                          </p>
                                          <p
                                            style="
                                              margin: 0;
                        ...
                        <table style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; border-spacing: 0px; width: 100%">
                          <tr>
                            <td style="text-align: left">
                              ...
                              <p style="mso-line-height-rule: exactly; letter-spacing: 0; font-size: 20px; font-style: normal; color: #293241">
                                We regretfully inform you that the services of your company will no longer be required. Therefore, we seek the
                                termination of our contact. This letter serves as an official notice for termination of the contract we will be
                                serving the notice period of 30 days as per the signed document.
                              </p>
                              <p style="mso-line-height-rule: exactly; letter-spacing: 0; font-size: 20px; font-style: normal; color: #293241">
                                Following are the reasons for the termination:
                              </p>
                              <ul style="mso-line-height-rule: exactly; letter-spacing: 0; font-size: 20px; font-style: normal; color: #293241">
                                <li>Inability to deliver</li>
                                <li>Untimely delivery</li>
                                <li>Unprofessional behaviour</li>
                                <li>Lack of requirement of the products - documents</li>
                              </ul>
                              <p style="mso-line-height-rule: exactly; letter-spacing: 0; font-size: 20px; font-style: normal; color: #293241">
                                However, we will not cancel any orders already agreed to before this letter, unless clearly mentioned otherwise.
                                Ideally, these services should be completed as normal. Please send any pending payment invoices, we will process them
                                at our normal payment cycle.
                              </p>
                              <p style="mso-line-height-rule: exactly; letter-spacing: 0; font-size: 20px; font-style: normal; color: #293241">
                                We thank you for providing your services to us.
                              </p>
                              <p
                                style="
                                  mso-line-height-rule: exactly;
