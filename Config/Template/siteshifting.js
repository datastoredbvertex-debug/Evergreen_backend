const SiteShifitingTemplate = (response) => {
                          ...
                          <tr style="text-align: center">
                            <td>
                              <h2
                                ...
                                "
                              >
                                Your inter Site transfer Letter
                              </h2>
                            </td>
                          </tr>
                        </table>
                        ...
                        <table style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; border-spacing: 0px; width: 100%">
                          <tr>
                            <td style="text-align: left">
                              <p style="mso-line-height-rule: exactly; letter-spacing: 0; font-size: 20px; font-style: normal; color: #293241">
                                Hello ${response.service_engineer}
                              </p>
                              <p style="mso-line-height-rule: exactly; letter-spacing: 0; font-size: 20px; font-style: normal; color: #293241">
                                We are writing this letter to inform you that your role will be transferred from the present Site- <br /><br />
                                ${response.presentsite.site_name} <br />
                                ${response.presentsite.location_name}.
                                <br /><br />
                                To the transfer Site <br /><br />
                                ${response.newsite.site_name}. <br />
                                ${response.newsite.location_name}.<br /><br />
                                This is because of the urgent requirement of manpower from the above transfer site. We believe your skillset will be
                                able to fulfil the requirement in our transfer site.
                              </p>

                              <p style="mso-line-height-rule: exactly; letter-spacing: 0; font-size: 20px; font-style: normal; color: #293241">
                                We're excited to see you join the Site with 42 Hours. We are sure you will fit in perfectly. on duty date time-
                                 ${response.newJoinDate}
                              </p>
                              <p style="mso-line-height-rule: exactly; letter-spacing: 0; font-size: 20px; font-style: normal; color: #293241">
                              ${
                                    response.supervisor && response.supervisor.length > 0
                                    ? `You must report to Mr ${response.supervisor[0].full_name} (Supervisor) (${response.supervisor[0].mobile}) at 09.00 am. If you have any questions, please get in touch with Shweta Yadav (HR Manager).`
                                    : `There is no supervisor available on site, please immediately contact HR Shweta Yadav (HR Manager).`
                              }
                              </p>
                              <p style="mso-line-height-rule: exactly; letter-spacing: 0; font-size: 20px; font-style: normal; color: #293241">
                                Regards,
...
module.exports = { SiteShifitingTemplate };
