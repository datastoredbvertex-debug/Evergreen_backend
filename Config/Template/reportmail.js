const ReportTemplate = (sites) => {
  console.log("sites:", sites);
  console.log("notWorkingProducts Details:", sites.notWorkingProducts);
  console.log("notWorkingImages:", sites.notWorkingProducts && sites.notWorkingProducts.length > 0 ? sites.notWorkingProducts[0].images : "No images available");
...
<html dir="ltr" xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" lang="en" style="padding: 0; margin: 0">
  <head>
    ...
    <title>Daily Update Report</title>
    <style type="text/css">
      #outlook a { padding: 0; }
                    ...
                    <tr style="border-collapse: collapse">
                      <td align="center" class="header-container">
                        <h1 style="margin: 0; line-height: 36px; font-family: 'lucida sans unicode', 'lucida grande', sans-serif; font-size: 30px; font-weight: bold; color: #333333">
                          <a target="_blank" style="text-decoration: none; color: #333333; font-size: 30px" href="https://www.evergreenion.com/">Evergreen Ion Enviro</a>
                        </h1>
                        <p style="margin: 10px 0; line-height: 27px; color: #333333; font-size: 18px"><strong>Daily Update Report</strong></p>
                                   ...
                                   <tr style="border-collapse: collapse"><td align="left"><b>Product Name:</b><strong>${notWorkingProduct.product_name}</strong></td></tr>
                                    <div class="not-working-product">
                                      ...
                                      <table cellpadding="0" cellspacing="0" width="100%" role="none" style="border-collapse: collapse; border-spacing: 0px">
                                        <tr style="border-collapse: collapse"><td align="left"><strong>${notWorkingProduct.product_name}</strong></td></tr>
                                        ...
                                        <tr style="border-collapse: collapse"><td align="left"><b>Problem Covered By:</b> ${
                                          notWorkingProduct.problem_covered === "Client" ? "Client" : notWorkingProduct.problem_covered === "Evergreenion" ? "Evergreenion" : notWorkingProduct.problem_covered || "N/A"
                                        }</td></tr>
                                      </table>
                                    </div>
                                  `
